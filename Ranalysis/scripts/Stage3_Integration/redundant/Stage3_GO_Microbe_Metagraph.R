...
# Builds a Cytoscape-ready metagraph by collapsing genes into GO:BP metanodes and
# microbes into risk-group or taxonomic metanodes.
...
run_fgsea_go_bp <- function(ranks) {
  ...
  if (nrow(fg) == 0) {
    stop("fgsea returned no GO terms.")
  }
